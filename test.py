...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_cls', type=int,
                        default=11)
    parser.add_argument('--conf_mat', action='store_true', help='save confusion matrix')
    parser.add_argument('--save_error', action='store_true', help='save misclassified images')
    parser.add_argument('--show_cam', action='store_true', help='save misclassified images with activated map')
    parser.add_argument('--metric', action='store_true', help='save model metric to .xls file')
